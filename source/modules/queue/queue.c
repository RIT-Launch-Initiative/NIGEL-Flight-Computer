...
// 0 = free, 1 = not
// since this is in BSS they are all initialized to free
static uint8_t free_nodes[NUM_QUEUE_NODES];
...
static void dealloc_node(q_node_t* node) {
    // search for which preallocated node this is
